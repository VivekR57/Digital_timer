...
void set_view_event(char key)
{
    static char sub_menu[][16] = {"SET EVENT", "VIEW EVENT"};
    static char m_ind = 0;
    ...
    clcd_print(sub_menu[m_ind], (0x80 + (2)));
    clcd_print(sub_menu[m_ind + 1], (0xC0 + (2)));
}
