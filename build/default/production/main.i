        ...
        if (current_state == e_default)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    clcd_print("Alarm", (0xC0 + (0)));
                    clcd_putch((e_hr / 10) + '0', (0xC0 + (6)));
                    clcd_putch((e_hr % 10) + '0', (0xC0 + (7)));
                    clcd_putch(':', (0xC0 + (8)));
                    clcd_putch((e_min / 10) + '0', (0xC0 + (9)));
                    clcd_putch((e_min % 10) + '0', (0xC0 + (10)));
                    clcd_putch(' ', (0xC0 + (11)));
                    clcd_putch(e_ap, (0xC0 + (12)));
                    clcd_putch('M', (0xC0 + (13)));
                }

                clcd_print("Time", (0x80 + (0)));
                clcd_print(time, (0x80 + (5)));


                if (clock_reg[0] & 0x40)
                {
                    clcd_print((clock_reg[0] & 0x20) ? "PM" : "AM", (0x80 + (13)));
                }
            }
...
void display_time(void)
{
    ...
    if (clock_reg[0] & 0x40)
    {
        clcd_print((clock_reg[0] & 0x20) ? "PM" : "AM", (0xC0 + (13)));
    }
}
