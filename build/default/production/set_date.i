...
void set_date(char key)
{
    ...
    if (delay++ < 500)
    {
        ...
        clcd_putch(' ', (0xC0 + (0)));
        clcd_putch('0' + dd / 10, (0xC0 + (1)));
        clcd_putch('0' + dd % 10, (0xC0 + (2)));
        clcd_putch('-', (0xC0 + (3)));
        clcd_putch('0' + mm / 10, (0xC0 + (4)));
        clcd_putch('0' + mm % 10, (0xC0 + (5)));
        clcd_putch('-', (0xC0 + (6)));
        clcd_putch('0' + yy / 10, (0xC0 + (7)));
        clcd_putch('0' + yy % 10, (0xC0 + (8)));
    }
    else
    {
