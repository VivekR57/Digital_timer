...
void view_event(char key)
{
    ...
    if (count == 0)
    {
        clcd_print(" NO EVENTS ", (0x80 + (3)));
        clcd_print(" STORED ", (0xC0 + (4)));
    ...
    clcd_print("  HH:MM AM/PM ", (0x80 + (0)));


    clcd_putch(' ', (0xC0 + (0)));
    clcd_putch(' ', (0xC0 + (1)));
    clcd_putch(read_eeprom(index * 6), (0xC0 + (2)));
    clcd_putch(read_eeprom(index * 6 + 1), (0xC0 + (3)));
    clcd_putch(':', (0xC0 + (4)));
    clcd_putch(read_eeprom(index * 6 + 2), (0xC0 + (5)));
    clcd_putch(read_eeprom(index * 6 + 3), (0xC0 + (6)));
    clcd_putch(' ', (0xC0 + (7)));
    clcd_putch(read_eeprom(index * 6 + 4), (0xC0 + (8)));
    clcd_putch(read_eeprom(index * 6 + 5), (0xC0 + (9)));
}
